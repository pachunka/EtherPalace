# this is a huge copy and paste because IT'S A HACKATHON

export default (pulse,bloverride,l3d,{width,height,THREE,SMUC,Web3}) ->
	#requestFilmFrame = (ff) ->
	filmReel = (ff) ->
		ltt = 0
		ffprocess = (tt) ->
		...
		requestAnimationFrame ffprocess
	#filmReel = queueMicrotask # DECEPTION
	#root = document.body
