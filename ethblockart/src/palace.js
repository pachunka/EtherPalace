...
export default function(pulse, bloverride, l3d, {width, height, THREE, SMUC, Web3, mod1, mod2}) {
  var addBaseline, addDiamond, addPyramid, ascpls, blockPlease, cache_only, display_cap, e3attempts, e3timer, ended, eth3, filmReel, lxo, nmipls, rawMaterials, sceneStart, sizeAndRezize, stage, token_smash, utfpls, web3, xl;
  //requestFilmFrame = (ff) ->
...
void main () {
  ...
  addBaseline = function(blk) {
    var oba, shp;
    stage.trn = blk.gasUsed * 0.00000000004 * (mod2);
  ...
  */
  ...
  (function() {    //queueMicrotask -> # this is the main 3d startup function and should probably be somewhere more ceremonious
    var caster, mx;
    rawMaterials();
    sceneStart();
    filmReel(function() {
      stage.ggr.rotation.z = mod1;
